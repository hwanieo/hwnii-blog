  ...
  return (
    <main className='relative min-h-screen overflow-y-scroll scrollbar-hide'>
      <div className='fixed inset-0 z-0'>
        {/* 컬러공 */}
        <div className='absolute bottom-0 left-0 w-[30rem] h-[30rem] bg-gradient-to-br from-pink-400 to-blue-500 rounded-full filter blur-3xl opacity-70 animate-float animate-move-around' />
